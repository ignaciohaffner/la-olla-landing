export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 flex items-center justify-center min-h-[44px] min-w-[44px] bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg transition-colors"
